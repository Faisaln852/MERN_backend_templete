...
activitySchema.index({ method: 1, timestamp: -1 });
activitySchema.index({ deviceType: 1, timestamp: -1 });

// Virtual for mobile detection
        ...
        methodDistribution: {
          $arrayToObject: {
            $map: {
              input: "$methods",
              as: "m",
              in: { k: "$$m", v: { $sum: 1 } }, // simple count placeholder
            },
          },
        },
        deviceDistribution: {
          $arrayToObject: {
            $map: {
              input: "$deviceTypes",
              as: "d",
              in: { k: "$$d", v: { $sum: 1 } }, // simple count placeholder
            },
          },
        },
      },
...
// Instance method to parse User-Agent
